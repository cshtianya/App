...
/**
 * A <code>UITagGroup</code> is a special layout with a set of tags.
 ...
 */
public class UITagGroup extends ViewGroup {
    ...
    private final int default_dishable_background_color = Color.argb(0x60, 0x49, 0xC1, 0x20);
    private final int default_pressed_background_color = Color.rgb(0xED, 0xED, 0xED);
    private final float default_tab_view_width;
    ...
    public UITagGroup(Context context) {
        this(context, null);
    }

    public UITagGroup(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.tagGroupStyle);
    }

    public UITagGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_tab_view_width = dp2px(40f);

        // Load styled attributes.
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.UITagGroup, defStyleAttr, R.style.UITagGroupStyle);
        try {
            borderColor = a.getColor(R.styleable.UITagGroup_atg_borderColor, default_border_color);
            textColor = a.getColor(R.styleable.UITagGroup_atg_textColor, default_text_color);
            backgroundColor = a.getColor(R.styleable.UITagGroup_atg_backgroundColor, default_background_color);
            backgroundDisableColor = a.getColor(R.styleable.UITagGroup_atg_backgroundDisableColor, default_dishable_background_color);
            checkedBorderColor = a.getColor(R.styleable.UITagGroup_atg_checkedBorderColor, default_checked_border_color);
            checkedTextColor = a.getColor(R.styleable.UITagGroup_atg_checkedTextColor, default_checked_text_color);
            checkedBackgroundColor = a.getColor(R.styleable.UITagGroup_atg_checkedBackgroundColor, default_checked_background_color);
            pressedBackgroundColor = a.getColor(R.styleable.UITagGroup_atg_pressedBackgroundColor, default_pressed_background_color);
            borderStrokeWidth = a.getDimension(R.styleable.UITagGroup_atg_borderStrokeWidth, default_border_stroke_width);
            textSize = a.getDimension(R.styleable.UITagGroup_atg_textSize, default_text_size);
            minWidth = (int)a.getDimension(R.styleable.UITagGroup_atg_minWidth, default_tab_view_width);
            minHight = (int)a.getDimension(R.styleable.UITagGroup_atg_minHight, default_tab_view_width);

            horizontalSpacing = (int) a.getDimension(R.styleable.UITagGroup_atg_horizontalSpacing, default_horizontal_spacing);
            verticalSpacing = (int) a.getDimension(R.styleable.UITagGroup_atg_verticalSpacing, default_vertical_spacing);
            horizontalPadding = (int) a.getDimension(R.styleable.UITagGroup_atg_horizontalPadding, default_horizontal_padding);
            verticalPadding = (int) a.getDimension(R.styleable.UITagGroup_atg_verticalPadding, default_vertical_padding);

            textDisableColor = Color.argb((int)(255*0.5)
...
//            index++;
     ...
     */
    private void appendTag(CharSequence tag,boolean isEnable) {
        final TagView newTag = new TagView(getContext(), TagView.STATE_NORMAL,tag,isEnable);
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new UITagGroup.LayoutParams(getContext(), attrs);
    }
    ...
    /**
     * For {@link UITagGroup} save and restore state.
     */
    ...
    private class TagView extends TextView {
        ...
        public TagView(Context context, final int state, CharSequence text,boolean isEnable) {
            super(context);
            this.setGravity(Gravity.CENTER);
            this.enable = isEnable;

            setPadding(horizontalPadding, verticalPadding, horizontalPadding, verticalPadding);
            UITagGroup.LayoutParams lp = new UITagGroup.LayoutParams(
                    UITagGroup.LayoutParams.WRAP_CONTENT,
                    UITagGroup.LayoutParams.WRAP_CONTENT);
            setLayoutParams(lp);

            this.setMinHeight(minHight);
...
//                }
                ...
                mBorderPaint.setColor(backgroundDisableColor);
                mBackgroundPaint.setColor(backgroundDisableColor);
