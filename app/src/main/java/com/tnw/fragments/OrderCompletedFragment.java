 ...
 * 订单-已完成
 */
public class OrderCompletedFragment extends BaseFragment implements
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == getActivity().RESULT_OK) {
            if (requestCode == AliPayUtils.ORDER_PAY_REQUEST_CODE) {
                controller.excute(OrderState.COMPLETED+"");
            }
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new OWaitPayAdapter(this.getActivity(), OrderState.COMPLETED);
            ...
            public void onGroupClick(OrderNode pInfo, boolean isOpreate) {
                ...
                if(pInfo!= null)
                    if (isOpreate) {
                        ...
                        OrderDetialActivity.launcher(OrderCompletedFragment.this
                                , pInfo.getOrderId()
                                , pInfo.getPayType()
                                , OrderState.WAIT_PAY
